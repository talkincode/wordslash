 ...
 * Includes comprehensive examples covering all card types and all available fields
 */
export function generateSampleTemplate(): BulkImportTemplate {
  return {
    ...
    cards: [
      ...
      // ============================================
      // Sentence Examples (type: 'sentence')
      // ============================================
      {
      ...
      // ============================================
      {
        ...
        // type: auto-inferred as 'word' (1 word)
        // morphemes: ['minimal', 'ist']
        // phonetic, translation, explanation, etc. can be added later
      },
    ],
  };
}
